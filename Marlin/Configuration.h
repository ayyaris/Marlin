...
#define STRING_CONFIG_H_AUTHOR "(Ayyari Abdennaby)" // Who made the changes.
#define SHOW_BOOTSCREEN // // BitMap boot splashscreen 
#define START_BMPHIGH  // High BitMap boot splashscreen
...
#define CUSTOM_MACHINE_NAME "GT2560"
